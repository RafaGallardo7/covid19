                            ...
                            <table id="tableCasos" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%">
                                <thead class="text-secondary">
                                    <tr>                                    
                                        ...
                                        <th>Sospechosos</th>				
                                        <th>Descartados</th>				
                                        <th>Muestras Tomadas</th>				
                                        <th>Aislamiento Domiciliario</th>				
                                        <th>Hospital Estables</th>				
                                        <th>Pronóstico Reservado</th>				
                                    </tr>
                                </thead>
                                <tbody class="font-size90">
                                    @foreach($fechas->reverse() as $index => $dato)                                
                                        <tr>                                                                                                                                                            
                                            <td style="white-space:nowrap;">{{$dato->fecha}}</td>
                                            <td>{{$dato->confirmados}}</td>
                                            <td>{{$dato->fallecidos}}</td>                                                                               
                                            <td>{{$dato->recuperados}}</td>                                                                               
                                            <td>{{$dato->sospechosos}}</td>                                                                               
                                            <td>{{$dato->descartados}}</td>                                                                               
                                            <td>{{$dato->muestras}}</td>                                                                               
                                            <td>{{$dato->domiciliario}}</td>                                                                               
                                            <td>{{$dato->hosp_estables}}</td>                                                                               
                                            <td>{{$dato->hosp_reservado}}</td>                                                                               
                                        </tr>
                                    @endforeach 
                                </tbody>
                            </table>
